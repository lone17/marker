...
from marker.cleaners.table import create_new_tables, merge_table_blocks
from marker.debug.data import dump_bbox_debug_data
from marker.extract_text import get_text_blocks
from marker.markdown import (
    get_full_text,
    merge_lines,
    merge_spans,
...
from marker.schema import BlockType, Page
...
def convert_single_pdf(
    ...
    cache_dir="/home/ian/document-qa/document_qa/data_processing/data/cache/",
) -> Tuple[str, Dict]:
    ...
    filtered_cache = cache_dir / "filtered.pkl"
    out_meta_cache = cache_dir / "out_meta.json"

    if filtered_cache.exists() and out_meta_cache.exists():
        with open(filtered_cache, "rb") as f:
            filtered = pickle.load(f)
        with open(out_meta_cache, "r", encoding="utf8") as f:
        ...
        with open(out_meta_cache, "w", encoding="utf8") as f:
    ...
    # sorted_lines = sort_blocks_reading_order(merged_lines)
